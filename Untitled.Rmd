...
```{r Figure 1, echo=TRUE, fig.cap="Figure 1: log(beta) distribution.", message=FALSE}
F1
```
...
```{r Figure 2, echo=TRUE, fig.cap="Figure 2: MCMC Simulations Traceplot.", message=FALSE}
F2
```
