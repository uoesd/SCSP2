...
* Prior C use a wider variance for coefficients of gender variables.

Since all other coefficients are relatively small, we don't talk about them.
...
As you can see in table $10$, the LOO validation shows the model is vary
