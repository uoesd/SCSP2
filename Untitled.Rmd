...
Figure 3 is the Posterior Predictive Check (PPC) density plot comparing with true value of $\beta$ (Here we have take exponential of both true value and predicted value). Notice that our BRM model fits a good posterior distribution even at right tail.
