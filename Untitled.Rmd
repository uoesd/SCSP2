...
Table $8$ shows the MSE of $\beta$, $V_d$ and calculated $C_0$ from joint posterior distribution comparing with true value, and also a MSE for single $\beta$ model to test if the results worse when take in $V_d$. The estimation result for $\beta$ is not worse than before. The calculated $C_0$ is pretty good from the coverage rate.
...
# Reference
[1] Chapter 6.4 (https://www.sciencedirect.com/science/article/pii/S0379073810000770?via%3Dihub)
