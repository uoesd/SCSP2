...
Then we prefer to $\beta$ to $\log(\beta)$ since the original $\beta$ distribution has heavy tail. After simulation we can take exponential of the results. As shown in figure, $\beta$ forms a good normal distribution shape after log-transferring.
