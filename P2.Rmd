...
Before fitting the Bayesian regression model, we should define appropriate priors for all regression coefficients and final residual. We use weakly informative priors, which have small effects on the posterior. The selected priors are summarized as follows:
